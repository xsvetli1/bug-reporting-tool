...
class GithubController implements IIssueController {
    static releaseTag = 'annotate-report-screenshots';
    ...
    async createRelease(): Promise<ReleaseInfo> {
        const response = await fetch(this.releasesApiUrl, {
            ...
            body: JSON.stringify({
                ...
                name: 'Annotate-Report screenshots',
                body:
                    '<b>Do not delete this release!</b><br />' +
                    'This release is used as a storage for all uploaded screenshots generated by Annotate-Report tool. ' +
